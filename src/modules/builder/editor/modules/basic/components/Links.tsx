  ...
  return (
    <Fragment>
      ...
      />
        ...
        label="Medium"
        variant="filled"
        value={networks[SUPPORTED_NETWORKS.medium].url}
        onChange={(event: ChangeEvent<HTMLInputElement>) => {
          onURLChange(event.target.value, SUPPORTED_NETWORKS.medium);
        }}
      />
			<TextField
        label="Stackoverflow"
        variant="filled"
        value={networks[SUPPORTED_NETWORKS.stackoverflow].url}
        onChange={(event: ChangeEvent<HTMLInputElement>) => {
          onURLChange(event.target.value, SUPPORTED_NETWORKS.stackoverflow);
        }}
      />
    </Fragment>
  );
