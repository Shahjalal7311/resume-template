  ...
  return (
    <ResumeContainer>
      ...
      <RightSection>
        ...
        <SectionValidator value={skills.languages.concat(skills.libraries)}>
          <Section title="Actively Working">
            <UnratedSkills items={skills.languages.concat(skills.libraries)} />
          </Section>
        </SectionValidator>

        <SectionValidator value={skills.frameworks}>
          <Section title="Frontend/Backend Frameworks">
            <UnratedSkills items={skills.frameworks} />
          </Section>
        </SectionValidator>

				<SectionValidator value={skills.databases}>
          <Section title="Database && Cache">
            <UnratedSkills items={skills.databases} />
          </Section>
        </SectionValidator>

				<SectionValidator value={skills.clouds}>
          <Section title="DevOps && Clode Platform">
            <UnratedSkills items={skills.clouds} />
          </Section>
        </SectionValidator>
